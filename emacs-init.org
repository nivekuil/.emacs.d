...
** Flyspell
Check spelling while editing text.
#+BEGIN_SRC emacs-lisp
(add-hook 'text-mode-hook 'flyspell-mode)
#+END_SRC

In programming languages, only check spelling in strings and comments.
#+BEGIN_SRC emacs-lisp
(add-hook 'prog-mode-hook 'flyspell-prog-mode)
#+END_SRC

Override flyspell keybindings.
#+BEGIN_SRC emacs-lisp
...
Update mailboxes every 30 minutes.
#+BEGIN_SRC emacs-lisp
