...
Use melpa and marmalade as package repositories.
#+BEGIN_SRC emacs-lisp
...
Org project settings for publishing my website.
#+BEGIN_SRC emacs-lisp
  (setq org-publish-project-alist
    ...
    ("org-website"
            ...
            :base-directory "~/code/nivekuil.github.io/org/"
            :base-extension "org"

            ;; Path to your Jekyll project.
            :publishing-directory "~/code/nivekuil.github.io/jekyll/"
            :recursive t
