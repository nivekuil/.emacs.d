...
** Helm
The following must be set before helm is loaded when tethered to my phone's data, due to T-Mobile's DNS hijacking, or emacs will hang.
#+BEGIN_SRC emacs-lisp
